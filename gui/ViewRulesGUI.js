...
export function openRulesets(imported) {
    ...
    for(let i = 0; i < rulesets.length; i++) {
        ...
        let rulesetRectangle = new UIRoundedRectangle(10)
            .setX(new CramSiblingConstraint(7.5))
            .setY(new CramSiblingConstraint(7.5))
            .setWidth(new SubtractiveConstraint((33.3).percent(), (5).pixels()))
            .setHeight(new SubtractiveConstraint((14.2).percent(), (6.4).pixels()))
            .onMouseEnter((comp) => {
                animate(comp, (animation) => {
        ...
        UIImage.ofFile(new File("./config/ChatTriggers/modules/HyJanitor/icons/g-forward.png"))
            ...
            .setX(new AdditiveConstraint(new CenterConstraint(), (42.5).percent()))
            .setY(new CenterConstraint())
            .setWidth((24).pixels())
            .setHeight(new AspectConstraint())
            .setChildOf(rulesetRectangle);
    ...
    let rulesetIcon = UIImage.ofFile(new File("./config/ChatTriggers/modules/HyJanitor/icons/g-edit_pencil.png"))
        .setColor(colorScheme.dark.onSecondaryContainer.color)
        .setX(new AdditiveConstraint(new CenterConstraint(), (42).percent()))
        .setY(new CenterConstraint())
        .setWidth((16).pixels())
        .setHeight(new AspectConstraint())
        .setChildOf(rulesetRectangle);
