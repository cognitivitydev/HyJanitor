...
export function openPresetForm(ruleset) {
    ...
    new UIWrappedText("Before uploading your ruleset, make sure a similar preset does not already exist. " +
        ...
        .setX((7.5).percent())
        .setY(new SiblingConstraint(16))
        .setWidth((80).percent())
        .setChildOf(container);

    new UIBlock()
        .setX((0).pixels())
        .setY(new SiblingConstraint(15))
        .setWidth((100).percent())
        .setHeight((1).pixels())
        .setColor(colorScheme.dark.outline.color)
        .setChildOf(container);
    ...
    const form = new UIRoundedRectangle(15)
        ...
        .setY(new SiblingConstraint(16))
        .setWidth((67).percent())
        .setHeight(new AdditiveConstraint(new ChildBasedRangeConstraint(), (32).pixels()))
        .setChildOf(container);
    ...
    const infoContainer = new UIContainer()
        .setX((0).pixels())
        .setY(new SiblingConstraint(12))
        .setWidth((100).percent())
        .setHeight((120).pixels())
        .setChildOf(form);

    UIImage.ofFile(new File("./config/ChatTriggers/modules/HyJanitor/icons/g-description.png"))
        .setColor(colorScheme.dark.onSurfaceVariant.color)
        .setX((7.5).percent())
        .setY(new SubtractiveConstraint(new CenterConstraint(), (40).percent()))
        .setWidth(new AspectConstraint())
        .setHeight((16.7).percent())
    ...
    UIImage.ofFile(new File("./config/ChatTriggers/modules/HyJanitor/icons/g-rule.png"))
        .setColor(colorScheme.dark.onSurfaceVariant.color)
        .setX((7.5).percent())
        .setY(new SubtractiveConstraint(new CenterConstraint(), (25).percent()))
        .setWidth(new AspectConstraint())
        .setHeight((16.7).percent())
    ...
    const versionInputOutline = new UIRoundedRectangle(4)
        .setColor(colorScheme.dark.outline.color)
        .setX((52.5).percent())
        .setY(new AdditiveConstraint(new CenterConstraint(), (3).percent()))
        .setWidth((32.5).percent())
        .setHeight((22).percent())
        .setChildOf(rulesetContainer);
    ...
    const typeInputOutline = new UIRoundedRectangle(4)
        .setColor(colorScheme.dark.outline.color)
        .setX((15).percent())
        .setY(new AdditiveConstraint(new CenterConstraint(), (31).percent()))
        .setWidth((70).percent())
        .setHeight((22).percent())
        .setChildOf(rulesetContainer);
    ...
    const titleWarning = new UIContainer()
        .setX(new CenterConstraint())
        .setY(new SiblingConstraint())
        .setWidth(new AdditiveConstraint(new ChildBasedSizeConstraint(), (8).pixels()))
        .setHeight((20).pixels())
        .setChildOf(form);
    titleWarning.hide(true);
